      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader >
          <DialogTitle  className="flex items-center">
            <span className="ml-2">Add Student to schedule</span>
          </DialogTitle>
        </DialogHeader>
        <form>
            ...
            <div>
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="work">Present</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="pto" id="pto" />
                  <Label htmlFor="pto">Absence</Label>
                </div>
              </RadioGroup>
            </div>
            <div className="mb-2">
              <Label htmlFor="staff">Students*</Label>
              <Select>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select..." />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="staff1">Student 1</SelectItem>
                  <SelectItem value="staff2">Student 2</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="mb-2">
